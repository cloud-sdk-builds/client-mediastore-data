...
[`@aws-sdk/client-mediastore-data`](https://www.npmjs.com/package/@aws-sdk/client-mediastore-data/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nwy3yUB5PIrHby4uXSLoFqGyzSANx0c48JULaop4pUERD2Vt3QdIqJnppOwlgEVH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediastore-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.160.0/index.min.mjs": "sha384-Nwy3yUB5PIrHby4uXSLoFqGyzSANx0c48JULaop4pUERD2Vt3QdIqJnppOwlgEVH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediastore-data/blob/refs/tags/3.160.0/LICENSE
```
