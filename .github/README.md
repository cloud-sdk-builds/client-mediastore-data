...
[`@aws-sdk/client-mediastore-data`](https://www.npmjs.com/package/@aws-sdk/client-mediastore-data/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wH9h0kCOHDGhP13+2rToFcm1NGC13WXNR9s7SWIpBYEITo0+swPahRk1FhyEP1Zb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediastore-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediastore-data@3.796.0/index.min.mjs": "sha384-wH9h0kCOHDGhP13+2rToFcm1NGC13WXNR9s7SWIpBYEITo0+swPahRk1FhyEP1Zb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediastore-data/blob/refs/tags/3.796.0/LICENSE
```
